...
![Start tracking](./start_tracking.png)
...
![Status indicator](./status_indicator.png)
...
![Open guides instruction](./open_guides_instruction.png)
...
![Open tracking settings](./open_tracking_settings.png)
...
![Tracking settings](./tracking_settings.png)
