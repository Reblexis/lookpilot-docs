...
2. Launch the game
3. Select the Tourist Bus Simulator Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Tourist Bus Simulator` in the game dropdown
