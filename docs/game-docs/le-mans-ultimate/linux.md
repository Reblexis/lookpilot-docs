...
2. Launch the game
3. Select the Le Mans Ultimate Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Le Mans Ultimate` in the game dropdown
...
2. Head tracking works automatically once LookPilot is running
