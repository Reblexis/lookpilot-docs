...
2. Launch the game
3. Select the Air Missions: Hind Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Air Missions: Hind` in the game dropdown
