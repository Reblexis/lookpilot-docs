...
2. Launch the game
3. Select the Construction Simulator Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Construction Simulator` in the game dropdown
