...
2. Launch the game
3. Select the Farming Simulator 17 Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Farming Simulator 17` in the game dropdown
...
## Farming Simulator 17 Setup
1. In-game, go to `Options` -> `General Settings`
