...
2. Launch the game
3. Select the Microsoft Flight Simulator 2004 Wine prefix in the `Game's Wine prefix` dropdown
...
2. Select the Microsoft Flight Simulator 2004 Wine prefix in the `Game's Wine prefix` dropdown
3. Launch the game
4. Click **Start tracking** to begin tracking

## Microsoft Flight Simulator 2004 Setup
