...
2. Launch the game
3. Select the Truck and Logistics Simulator Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Truck and Logistics Simulator` in the game dropdown
...
## Truck and Logistics Simulator Setup
