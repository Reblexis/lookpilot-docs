...
2. Launch the game
3. Select the Train Sim World 2 Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Train Sim World 2` in the game dropdown
