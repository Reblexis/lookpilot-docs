...
2. Launch the game
3. Select the FlyInside Flight Simulator Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `FlyInside Flight Simulator` in the game dropdown
...
## FlyInside Flight Simulator Setup
