...
2. Launch the game
3. Select the Microsoft Flight Simulator 2024 Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Microsoft Flight Simulator 2024` in the game dropdown
4. Launch the game from Steam
5. Click **Start tracking** to begin tracking

## Microsoft Flight Simulator 2024 Setup
Head tracking works automatically once configured.
