...
2. Launch the game
3. Select the Helicopter Gunship DEX Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Helicopter Gunship DEX` in the game dropdown
