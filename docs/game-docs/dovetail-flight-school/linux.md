...
2. Launch the game
3. Select the Dovetail Flight School Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Dovetail Flight School` in the game dropdown
