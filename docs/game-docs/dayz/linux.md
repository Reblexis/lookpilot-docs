...
2. Launch the game
3. Select the DayZ Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `DayZ` in the game dropdown
...
2. Head tracking works automatically with no in-game configuration required
