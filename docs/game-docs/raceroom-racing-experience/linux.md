...
2. Launch the game
3. Select the RaceRoom Racing Experience Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `RaceRoom Racing Experience` in the game dropdown
...
## RaceRoom Racing Experience Setup
