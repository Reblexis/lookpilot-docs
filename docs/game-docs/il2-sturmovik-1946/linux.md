...
## IL-2 Sturmovik: 1946 Setup
1. If launching the game from Steam, make sure to force the use of specific compatibility tool (Proton).
2. Head tracking should work automatically. If it doesn't respond, make sure you are in cockpit view (press F1).
3. It is recommended to unmap your joystick hat switches from "View" controls in the game's input settings to avoid conflicts with head tracking.
