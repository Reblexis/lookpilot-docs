...
2. Configure SimConnect in opentrack using the [SimConnect protocol documentation](https://mintlify.com/opentrack/opentrack/protocols/simconnect).
...
5. Launch the game. If tracking fails after the first setup, fully quit and restart the sim.
...
2. Fully quit and restart FSX after the first opentrack connection.
