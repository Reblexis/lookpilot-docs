...
2. Launch the game
3. Select the Combat Air Patrol 2 Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Combat Air Patrol 2` in the game dropdown
