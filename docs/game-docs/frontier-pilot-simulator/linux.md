...
2. Launch the game
3. Select the Frontier Pilot Simulator Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Frontier Pilot Simulator` in the game dropdown
...
## Frontier Pilot Simulator Setup
