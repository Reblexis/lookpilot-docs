...
2. Launch the game
3. Select the Fernbus Simulator Wine prefix in the `Game's Wine prefix` dropdown
...
3. Set Game to `Fernbus Simulator` in the game dropdown
